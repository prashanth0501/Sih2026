...
export function AdminHome() {
  ...
  const totalStudents = stats?.total_students ?? teams?.reduce((acc, t) => acc + (t.members?.length || 0), 0) ?? 0;
    ...
    <div>
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-[0.85rem] text-ink-soft">Live real-time team statistics from Cloudflare D1</p>
        </div>
